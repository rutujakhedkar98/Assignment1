...
// Endpoint 1: Sort hotels by pricing
app.get('/hotels/sort/pricing', (req, res) => {
  const pricing = req.query.pricing;
  const sortedHotels = hotels.sort((a, b) =>
    pricing === 'high-to-low' ? b.price - a.price : a.price - b.price
  );
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  const sortedHotels = hotels.sort((a, b) =>
    rating === 'high-to-low' ? b.rating - a.rating : a.rating - b.rating
  );
  res.json(sortedHotels);
});

// Endpoint 3: Sort hotels by reviews
app.get('/hotels/sort/reviews', (req, res) => {
  const reviews = req.query.reviews;
  const sortedHotels = hotels.sort((a, b) =>
    reviews === 'most-to-least' ? b.reviews - a.reviews : a.reviews - b.reviews
  );
  res.json(sortedHotels);
});
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  const filteredHotels = hotels.filter((hotel) =>
    hotel.amenity.includes(amenity)
  );
